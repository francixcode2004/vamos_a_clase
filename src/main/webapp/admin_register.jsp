...
%>
    <div class="flex flex-col min-h-screen">
       ...
       <form action="${pageContext.request.contextPath}/InstructorServlet" method="post" enctype="multipart/form-data">
	    ...
	    <input id="phone" name="phone" type="tel" placeholder="Ingresa el número de teléfono">
	    ...
	    <input id="password" name="password" type="password" placeholder="Ingresa una contraseña segura">
			<label for="teaching-subject">Tema que enseña</label>
		   <%
